        ...
        <ul className='hidden md:flex gap-4 uppercase font-medium'>
          {authState.isLoggedIn ? (
            <>
              ...
              <li className='py-2 px-3 cursor-pointer bg-yellow-300  font-medium rounded-md hover:bg-gray-200 transition ' onClick={handleLogoutClick}>Logout</li>
            </>
          ) : (
            <li className='py-2 px-3 cursor-pointer text-primary bg-yellow-300  font-medium rounded-md hover:bg-gray-100 transition '><Link to="/login">Login</Link></li>
          )}
        </ul>
          ...
          <ul className='flex flex-col gap-4 uppercase font-medium text-center'>
            {authState.isLoggedIn ? (
              <>
                ...
                <li className='py-2 px-3 cursor-pointer hover:bg-gray-200 transition bg-yellow-300  font-medium rounded-md' onClick={handleLogoutClick}>Logout</li>
              </>
            ) : (
              <li className='py-2 px-3 cursor-pointer text-primary hover:bg-gray-200 transition bg-yellow-300  font-medium rounded-md'><Link to="/login">Login</Link></li>
            )}
          </ul>
        </div>
      </header>
